      ...
      {items.map((t) => (
        <div
          ...
          className={cn(
            ...
            t.variant === 'success' && 'bg-accent-green/20 border-accent-green text-primary-900',
            t.variant === 'error' && 'bg-red-500/20 border-red-500 text-primary-900',
            t.variant === 'info' && 'bg-primary-800 border-white/10 text-primary-900',
          )}
        >
          {t.message}
        </div>
